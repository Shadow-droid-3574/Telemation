...
const UserManagement: React.FC<UserManagementProps> = ({ admins, moderators, addAdmin, removeAdmin, addModerator, removeModerator }) => {
    ...
    return (
        <div>
            ...
            <p className="text-text-secondary mb-8">Assign roles and manage permissions for your bot.</p>
